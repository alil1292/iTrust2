...
<%
			 ...
			 String exID = StringEscapeUtils.escapeHtml("" + (ov.getHcpID()));
			 String ovID = StringEscapeUtils.escapeHtml("" + (ov.getVisitID()));
			 String ovDate = StringEscapeUtils.escapeHtml("" + (df.format(ov.getVisitDate())));
			 
%>
				<td >
					<a href="survey.jsp?expertID=<%= exID  %>&ovID=<%= ovID  %>&ovDate=<%= ovDate  %>">
